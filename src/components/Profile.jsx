    ...
    <section id="profile" className="relative min-h-screen flex items-center justify-center bg-black overflow-hidden py-20 px-4 sm:px-6" ref={containerRef}>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-7xl mx-auto">
        ...
        <div className="text-center lg:text-left space-y-6 max-w-2xl">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-300" style={{ minHeight: '90px' }}>
          ...
          <div className="flex justify-center lg:justify-start items-center gap-4 pt-8 flex-wrap">
            <a
              href="https://github.com/iro2002"
              target="_blank"
              rel="noopener noreferrer"
              className="group px-8 py-3 bg-white/10 border border-white/20 rounded-full text-white transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden font-semibold"
            >
            ...
            <a
              href="https://gitlab.com/irosh2002"
              target="_blank"
              rel="noopener noreferrer"
              className="group px-8 py-3 bg-white/10 border border-white/20 rounded-full text-white transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden font-semibold"
            >
              <span className="relative z-10 group-hover:text-black">GitLab</span>
              <div className="absolute inset-0 bg-white transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-in-out"></div>
            </a>

            <a
              href="https://www.linkedin.com/in/chamindu-irosh-9b1844315/"
              target="_blank"
              rel="noopener noreferrer"
              className="group px-8 py-3 bg-white/10 border border-white/20 rounded-full text-white transition-all duration-300 hover:scale-105 hover:shadow-xl relative overflow-hidden font-semibold"
            >
              <span className="relative z-10 group-hover:text-black">LinkedIn</span>
              <div className="absolute inset-0 bg-white transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-in-out"></div>
            </a>
            ...
            <a
              href="mailto:chaminduirosh927@gmail.com"
              className="group px-8 py-3 bg-white/10 border border-white/20 rounded-full text-white 
            ...
            >
              ...
              <div className="absolute inset-0 bg-white transform -translate-x-full 
                              group-hover:translate-x-0 transition-transform duration-500 ease-in-out"></div>
            </a>
          </div>
        </div>
      </div>
